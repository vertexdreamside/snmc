...
export type ElectionStatus =
  ...
  | "Election Closed"
  | "Completed";
export type CandidateStatus = "Nominated" | "Pending" | "Accepted" | "Declined" | "Removed" | "Elected" | "Not Elected";
...
export interface Person {
  ...
  is_active: boolean;
  is_deceased: boolean; // the sole nomination/voting eligibility gate — see migration 0009
...
export interface Election {
  ...
  live_results_visible: boolean; // admin-only monitoring setting — never gates what a voter can see
}
...
export interface Candidate {
  ...
  current_placement_note: string | null;
