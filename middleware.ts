...
// requires a session that logging in is meant to establish. See the fixed
// self-redirect bug this replaced — the route group is the real fix;
// this middleware's own path exclusions below are a second, independent
// safeguard, not the only thing preventing it.
