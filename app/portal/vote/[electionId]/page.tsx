  ...
  if (!isOpen) {
    return (
      <p className="font-body text-council-ink/60 max-w-xl mx-auto">
        Voting for {election.term_label} is not currently open.
      </p>
    );
  }
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      ...
      {eligibleCategories.length === 0 ? (
        <p className="font-body text-council-ink/60">Your registration status doesn't currently permit voting.</p>
      ) : (
