    ...
    <div className="min-h-screen bg-[#0F3D2E] flex items-center justify-center px-6">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-8">
        <div className="flex flex-col items-center mb-6">
          <h1 className="text-lg font-semibold text-[#16241C]">SNMC Admin</h1>
          <p className="text-sm text-[#3C4A41] mt-1">Sign in to the Council Voting &amp; Registration Platform</p>
        </div>
