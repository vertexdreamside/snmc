...
//
// Every export is now logged: who, which dataset, when, and how many
// rows — this is real personal data leaving the system as a downloadable
// file, which previously happened with zero audit trail.
...
export async function GET(request: Request) {
  ...
  await service.from("audit_log").insert({
    ...
    target_table: dataset === "register" ? "people" : dataset === "candidates" ? "candidates" : "councillor_terms",
